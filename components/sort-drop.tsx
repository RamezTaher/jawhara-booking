        ...
        <Fragment>
          <Menu.Button as={"div"} className={"w-full h-full "}>
            <div
              ...
              } gap-10 py-1.5 px-4 border border-solid border-primary bg-white ease-in duration-150 transition-all`}
            >
              <div className="text-secondary font-semibold">
                {t("search:best-value")}
              </div>
              <i
                className={`icon-expand_more_black_24dp text-primary text-xl transform transition ease-in-out duration-200 ${
                  open && " rotate-180"
                }`}
              ></i>
            </div>
